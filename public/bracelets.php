...
$products = get_products_bracelets();
...
?>
    ...
    <div class="jumbotron text-center">
        <h1>Bracelets</h1>
        <p>Please check our selection of <?php echo $productsCount ?> bracelets styles!</p>
    </div>
        ...
        <div class="row">
            <?php  foreach ($products as $row) {?>
                ...
                <div class="col-sm-4">
                    ...
                    <img src="/sites/GlamouresqOnlineStore/public/img/<?php echo $row['photo']; ?>" class="img-rounded" height="300" width="300">
