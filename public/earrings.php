...
$products = get_products_earrings();
...
?>
    ...
    <div class="jumbotron text-center">
        <h1>Earrings</h1>
        <p>Please check our selection of <?php echo $productsCount ?> earrings styles!</p>
    </div>
    ...
    <style>
        .col-sm-4 {
            ...
            <div class="col-sm-4">
                ...
                <img src="/sites/GlamouresqOnlineStore/public/img/<?php echo $row['photo']; ?>" class="img-rounded" height="250" width="250">
